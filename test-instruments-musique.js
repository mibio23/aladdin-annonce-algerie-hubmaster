...
// Test principal
function testInstrumentsMusique() {
  console.log('🔍 Test de la catégorie "Instruments de Musique"...');
...
// Exécuter le test
const success = testInstrumentsMusique();
...
fs.writeFileSync(
  path.join(__dirname, 'test-instruments-musique-results.json'),
  JSON.stringify(results, null, 2)
);

console.log(`\n📄 Résultats du test sauvegardés dans: test-instruments-musique-results.json`);