...
console.log('🔍 Correction des erreurs de syntaxe dans le fichier de catégories...');
...
// 6. Corriger les virgules manquantes à la fin des objets
content = content.replace(/}\s*\n\s*}/g, '},\n      }');

// 7. Corriger les erreurs de structure spécifiques
content = content.replace(/}\s*\n\s*\]/g, '}\n      ]');
