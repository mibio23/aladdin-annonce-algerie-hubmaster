// Script de création pour la catégorie "Collections & Brocante"
// Support: Français, Arabe, Anglais, Allemand, Espagnol

const collectionsBrocante = {
...
console.log('📋 Structure de la catégorie "Collections & Brocante" créée avec succès');
console.log('📊 Sous-catégories:', collectionsBrocante.subcategories.length);
console.log('🌍 Langues supportées:', Object.keys(collectionsBrocante.translations).length);

// Exporter pour utilisation
export default collectionsBrocante;