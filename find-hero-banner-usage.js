// Script pour trouver où est utilisé useHeroBannerData

import fs from 'fs';
import path from 'path';

console.log('Recherche des fichiers qui utilisent useHeroBannerData...\n');
...
const results = searchInDirectory('.', 'useHeroBannerData');

if (results.length === 0) {
  console.log('Aucun fichier n\'utilise useHeroBannerData.');
} else {
  console.log(`\n=== ${results.length} fichier(s) utilisent useHeroBannerData ===`);
