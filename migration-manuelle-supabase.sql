-- ========================================
-- Migration Manuelle des Tables Supabase
-- ========================================
...
CREATE POLICY IF NOT EXISTS "Everyone can view active categories" 
...
CREATE POLICY IF NOT EXISTS "Admins can manage categories" 
  ON public.categories 
  FOR ALL 
  TO authenticated
  USING (
...
CREATE POLICY IF NOT EXISTS "Everyone can insert views" 
  ON public.announcement_views 
  FOR INSERT 
  WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Admins can view all views" 
  ON public.announcement_views 
  FOR SELECT 
  TO authenticated
  USING (
