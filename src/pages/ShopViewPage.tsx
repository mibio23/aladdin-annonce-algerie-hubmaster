  ...
  useEffect(() => {
    const fetchShop = async () => {
      try {
        ...
        const combinedShops = [...userShops, ...allShops];
        const foundShop = combinedShops.find((s: Shop) => s.id === id);
                    ...
                    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex items-center gap-2">
                            <Store className="h-4 w-4 text-primary" />
                            <span>Statut de la boutique: {shop.shopStatus ? t(`createShop.shopInfo.status.${shop.shopStatus}`) : 'Non spécifié'}</span>
                          </div>
                        </div>
                      </div>
